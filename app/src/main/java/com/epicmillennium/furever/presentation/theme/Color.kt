...
//BottomNavBar Icons
val selectedNavBarIconColor = Color(0xFF94B8FF)
val gradientStrongNavBarIconColor = Color(0xFFD5E2FB)
val gradientWeekNavBarIconColor = Color(0xFF88B0FF)

//Shadows
val cardShadowColor = Color(0xFFACACAC)