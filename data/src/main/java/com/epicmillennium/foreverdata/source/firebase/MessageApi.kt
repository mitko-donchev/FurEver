...
import com.epicmillennium.foreverdata.source.firebase.AuthApi
...
import com.epicmillennium.foreverdata.source.firebase.model.FirestoreMessage
import com.epicmillennium.foreverdata.source.firebase.model.FirestoreMessageProperties
        ...
        coroutineScope {
            ...
            val lastMessageResult = async {
                FirebaseFirestore.getInstance()
                    .collection(MATCHES)
                    .document(matchId)
                    .update(mapOf(FirestoreAdoptionProperties.lastMessage to text))
                    .getTaskResult()
            }
